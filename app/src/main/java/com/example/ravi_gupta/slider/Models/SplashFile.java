...
public class SplashFile extends VirtualObject {
    ...
    @Transient
    public void setContainerRef(SplashContainer container) { this.container = container; }
    @Transient
    public SplashContainer getContainerRef() { return container; }
