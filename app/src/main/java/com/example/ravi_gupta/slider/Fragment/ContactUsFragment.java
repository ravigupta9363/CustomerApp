...
public class ContactUsFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contactUs = (Button)rootview.findViewById(R.id.fragment_contact_us_button2);

        contactText.setTypeface(typeface2);
        mailUs.setTypeface(typeface2);
        contactUs.setTypeface(typeface2);

        TextView toolbarTitle = (TextView)rootview.findViewById(R.id.fragment_contact_us_textview4);
        ImageButton toolbarIcon = (ImageButton)rootview.findViewById(R.id.fragment_contact_us_imagebutton1);
        ...
        String text = "<p>Want to say something?<br />Write us or call us in the case you want any shop to be added or in need of more discount";
        contactText.setText((Html.fromHtml(text)));
